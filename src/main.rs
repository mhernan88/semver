...
impl Semver {
    fn from_string(&mut self, version: String) -> Result<(), &'static str> {
    ...
    fn increment_major(&mut self) -> Result<(), &'static str> {
        if self.major == None {
    ...
    fn increment_minor(&mut self) -> Result<(), &'static str> {
        if self.major == None {
    ...
    fn increment_patch(&mut self) -> Result<(), &'static str> {
        if self.major == None {
